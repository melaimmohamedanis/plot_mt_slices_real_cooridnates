...
OUTPUT_FOLDER = os.path.join(GRD_FOLDER_PATH, 'Output_Plots_N_2.5')
...
def plot_and_save_map(stations, bbox, center_pt, grd_path, w_north_str, w_east_str, save_dir):
    ...
    norm_linear = colors.Normalize(vmin=0, vmax=2.5)
    ...
    im = ax.pcolormesh(LON_G, LAT_G, data_log10, cmap=cmap_discrete, norm=norm_linear, shading='nearest', alpha=0.9)
